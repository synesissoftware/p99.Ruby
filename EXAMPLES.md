...
| **measure_batch_latency** | [examples/measure_batch_latency.rb](./examples/measure_batch_latency.rb)<br/>[examples/measure_batch_latency.md](./examples/measure_batch_latency.md) | Measures simulated batch-operation latency with a monotonic clock, records seconds, and prints fixed percentile results |
